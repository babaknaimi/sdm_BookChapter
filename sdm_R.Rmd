...
\
\
\definecolor{headercolor}{rgb}{0.2, 0.6, 0.8}  % Define a custom color for the header
\definecolor{rowcolor}{rgb}{0.2, 0.5, 0.2}     % Define a custom color for the row names
...
\begin{tabular}{|>{\columncolor{rowcolor}}c|>{\columncolor{headercolor}}c|>{\columncolor{headercolor}}c|}
\hline
\rowcolor{headercolor!80}                 & \textcolor{white}{\textbf{Predicted Presence}} & \textcolor{white}{\textbf{Predicted Absence}} \\ \hline
\textcolor{white}{\textbf{Observed Presence}}  & True Positives (TP)  & False Negatives (FN) \\ \hline
\textcolor{white}{\textbf{Observed Absence}}   & False Positives (FP) & True Negatives (TN)  \\ \hline
\end{tabular}
